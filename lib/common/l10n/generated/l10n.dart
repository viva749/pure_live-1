...
class S {
  ...
  String get app_legalese {
    return Intl.message(
      'User privacy is collected by Supbase, the app directly requests the official interface except for detection updates, and the data generated by all operations is kept locally by the user.',
      name: 'app_legalese',
      desc: '',
      args: [],
    );
